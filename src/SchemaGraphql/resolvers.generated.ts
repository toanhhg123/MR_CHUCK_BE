...
import    { User } from './user/resolvers/User';
    export const resolvers: Resolvers = {
      Query: { getMe: Query_getMe,getMessage: Query_getMessage,getMessageByMessageBoxId: Query_getMessageByMessageBoxId,getMessagesBoxForMe: Query_getMessagesBoxForMe,getRoles: Query_getRoles,getUser: Query_getUser,getUsers: Query_getUsers },
