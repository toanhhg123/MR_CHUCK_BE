...
export const resolvers: Resolvers = {
  Query: {
    getCaseById: Query_getCaseById,
    getCases: Query_getCases,
    getLocations: Query_getLocations,
    getMe: Query_getMe,
    getMessageByRoomId: Query_getMessageByRoomId,
    getMyCases: Query_getMyCases,
    getRoles: Query_getRoles,
    getRoomById: Query_getRoomById,
    getRoomsByCaseId: Query_getRoomsByCaseId,
    getUser: Query_getUser,
    getUsers: Query_getUsers,
    searchUser: Query_searchUser
  },
  Mutation: {
    addJunrorToCase: Mutation_addJunrorToCase,
    addUserToCase: Mutation_addUserToCase,
    addUserToRooms: Mutation_addUserToRooms,
    addUsersToRoom: Mutation_addUsersToRoom,
    createCase: Mutation_createCase,
    createLocation: Mutation_createLocation,
    createMessageCase: Mutation_createMessageCase,
    createRole: Mutation_createRole,
    ...
    sendMessageToRoom: Mutation_sendMessageToRoom,
